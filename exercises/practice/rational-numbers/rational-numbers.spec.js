...
class Rational {
  constructor(numerator, denominator) {
    Object.assign(this, { numerator, denominator });
  }
  add(other) {
    return new Rational(...currentInstance.exports.add(
      this.numerator,
      this.denominator,
      other.numerator,
      other.denominator
  ...
  sub(other) {
    return new Rational(...currentInstance.exports.sub(
      this.numerator,
      this.denominator,
      other.numerator,
      other.denominator
  ...
  mul(other) {
    return new Rational(...currentInstance.exports.mul(
      this.numerator,
      this.denominator,
      other.numerator,
      other.denominator
  ...
  div(other) {
    return new Rational(...currentInstance.exports.div(
      this.numerator,
      this.denominator,
      other.numerator,
      other.denominator
  ...
  abs() {
    return new Rational(...currentInstance.exports.abs(
      this.numerator,
      this.denominator
    ));
  }
  exprational(pow) {
    return new Rational(...currentInstance.exports.exprational(
      this.numerator,
      this.denominator,
      pow
    ));
  ...
  expreal(exp) {
    return currentInstance.exports.expreal(this.numerator, this.denominator, exp)
  }
  reduce() {
    return new Rational(...currentInstance.exports.reduce(
      this.numerator,
      this.denominator
    ));
  }
...
describe('Addition', () => {
  xtest('Add two positive rational numbers', () => {
...
describe('Exponentiation of a real number to a rational number', () => {
  xtest('Raise a real number to a positive rational number', () => {
    const expected = 16.0;
    expect(new Rational(4, 3).expreal(8)).toBeCloseTo(expected, 2);
  });

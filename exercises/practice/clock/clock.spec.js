...
beforeAll(async () => {
  try {
    //const watPath = new URL("./clock.wat", import.meta.url);
...
class Clock {
  constructor(hour, minute) { Object.assign(this, { hour, minute }); }
  plus(minutes) {
    return new Clock(...currentInstance.exports.plus(this.hour, this.minute, minutes));
  }
  minus(minutes) {
    return new Clock(...currentInstance.exports.minus(this.hour, this.minute, minutes));
  }
  toString() {
    const [outputOffset, outputLength] = currentInstance.exports.toString(this.hour, this.minute);
    return currentInstance.get_mem_as_utf8(outputOffset, outputLength);
  }
  equals(other) {
    return Boolean(currentInstance.exports.equals(this.hour, this.minute, other.hour, other.minute));
  }
}
